<template>
  <div class="fill-height d-flex flex-column py-4 px-4">
    ...
    <v-row align="center" class="mt-2 mb-6">
      ...
      <v-col cols="12" md="8">
        <div class="px-2">
            <div 
                :style="xs||sm ? {'display':'none'} : {'font-size':'3.8rem', 'letter-spacing': '3px', 'line-height': '1.2'}" 
                class="lbc-left-welcome text-center mb-4"
                style="text-shadow: 0 4px 12px rgba(0,0,0,0.4); white-space: nowrap; font-weight: bold;"
            >
            ...
            <typewriter class="mt-3 d-flex align-center justify-center text-grey-lighten-2" style="min-height: 20px; font-size: 1rem;"></typewriter>
        </div>
      </v-col>

      <v-col cols="12" md="4" class="d-flex justify-center" style="align-self: center;">
          <div class="d-flex align-center" style="transform-origin: center center;">
    ...
    <div class="flex-grow-1 pr-md-16">
        <v-row no-gutters class="mb-4">
            <v-col cols="12">
                <v-chip 
                    ...
                    size="large" 
                    class="font-weight-bold px-0 pl-1"
...
.search-bar-glass :deep(.v-field) {
    ...
    backdrop-filter: blur(15px); /* 标准语法 */
